...
class Processor:
    ...
    def __init__(
        ...
        self.base_speculative_tokens = vllm_config.speculative_config.num_speculative_tokens if vllm_config.speculative_config else 0
        # 动态调整的推测token数量
        self.sd_num = [self.base_speculative_tokens]
