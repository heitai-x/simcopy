...
class AsyncLLM(EngineClient):
    ...
    def __init__(
        ...
        maybe_register_config_serialize_by_value()
        print(f"[主进程] AsyncLLM PID: {os.getpid()}, TID: {threading.get_ident()}")
        ...
        print("初始化engine_core")
        print(f"executor_class:{executor_class};client_addresses:{client_addresses};client_index:{client_index}")
