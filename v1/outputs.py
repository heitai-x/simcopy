...
class ModelRunnerOutput:
    ...
    # req_id -> sd_num (speculative decoding token number)
    # Used to track the dynamically adjusted speculative decoding window size
    sd_num: Optional[dict[str, list[int]]] = None
